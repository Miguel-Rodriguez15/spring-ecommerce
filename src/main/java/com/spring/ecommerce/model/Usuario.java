...
/**
 * Clase Usuario con sus respectivos actributos y relaciones
 *
...
public class Usuario {
    ...
    /**
     * Constructos del usuario
     *
     * @param id        , identificador del usuario autoincrementable
     * @param nombre    , nombre de la persona
     * @param username  , nombre del usuario
     * @param email     ,  correo del  usuario
     * @param direccion , direccion de la persona
     * @param telefono  , numero de telefono del usuario
     * @param tipo      , tipo de usuario (USER-ADMIN)
