...
public class OrdenServiceImpl implements IOrdenService {
	...
	public String generarNumeroOrden() {
		int numero = 0;//con este vamos incrementando el numero de la ordes para despues pasarlo a un string
		...
		ordenes.stream().forEach(o -> numeros.add(Integer.parseInt(o.getNumero())));//hacemops las convercion de cadenas de la base de datos a numeros
		if(ordenes.isEmpty()) {
			numero=1;
		...
		if(numero<10) {// en caso dado el numero sea menor a 10 este se le agregaran 9 ceros
